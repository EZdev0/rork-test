...
import {
  ...
  FolderOpen, Code, Search, Lightbulb, PenTool, Heart
...
export default function ChatScreen() {
  ...
  const renderMessage = useCallback(({ item, index }: { item: ChatMessage, index: number }) => {
    ...
    return (
      <View>
        {index > 0 && index % 5 === 0 && !settings?.hideSponsor && (
          <View style={{ marginVertical: 12, padding: 12, backgroundColor: IDE.surface, borderRadius: 8, borderWidth: 1, borderColor: IDE.border }}>
